...
Google ChromeおよびMicrosoft Edgeでプロキシーのユーザー認証ダイアログが表示されたとき、自動でユーザー名およびパスワードを入力するソリューションです。
...
3. プロキシーのユーザー認証ダイアログに、設定ファイルで指定したユーザー名とパスワードが自動入力され、サインインボタンが押されること確認します。

## Google Chromeでの確認

1. Google Chromeを起動します。
2. プロキシを経由する必要があるサイトへアクセスします。
3. プロキシーのユーザー認証ダイアログに、設定ファイルで指定したユーザー名とパスワードが自動入力され、ログインボタンが押されること確認します。
